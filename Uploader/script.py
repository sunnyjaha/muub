...
𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 ʙʏ : [𝓐𝓜-𝓡𝓞𝓑𝓞𝓣𝓢 ꒲](https://t.me/AmRobots_Bots)
"""
    HELP_TEXT = """
...
"""
    ABOUT_TEXT = """
**Mʏ ɴᴀᴍᴇ** : [ᴜᴘʟᴏᴀᴅᴇʀ ʙᴏᴛ](http://t.me/UrlUploaderAmrobot)

**Cʜᴀɴɴᴇʟ** : [𝓐𝓜-𝓡𝓞𝓑𝓞𝓣𝓢](https://t.me/AmRobots_Bots)

**Vᴇʀꜱɪᴏɴ** : [2.0 ʙᴇᴛᴀ](https://t.me/AmRobots_Bots)

**Sᴏᴜʀᴄᴇ** : [ᴄʟɪᴄᴋ ʜᴇʀᴇ](https://t.me/AM_ROBOTS)

**Sᴇʀᴠᴇʀ** : [𝓐𝓜-𝓡𝓞𝓑𝓞𝓣𝓢 ꒲](https://youtube.com/@AMROBOTS)

**Lᴀɴɢᴜᴀɢᴇ :** [Pʏᴛʜᴏɴ 3.10.2](https://www.python.org/)

**Fʀᴀᴍᴇᴡᴏʀᴋ :** [ᴘʏʀᴏɢᴀᴍ 2.0.30](https://docs.pyrogram.org/)

**Dᴇᴠᴇʟᴏᴘᴇʀ :** [𝓐𝓜-𝓡𝓞𝓑𝓞𝓣𝓢 ꒲](https://t.me/AM_ROBOTS)
...
"""
    ID_TEXT = """
🆔 Your Telegram ID 𝐢𝐬 :- <code>{}</code> \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots
"""
...
𝚆𝚊𝚗𝚝 𝚜𝚊𝚖𝚎 bot like 𝚝𝚑𝚒𝚜? 𝙳𝙼 - @AM_ROBOTS
...
"""
    ...
    TEXT = "sᴇɴᴅ ᴍᴇ ᴀɴʏ ᴄᴜsᴛᴏᴍ ᴛʜᴜᴍʙɴᴀɪʟ ᴛᴏ sᴇᴛ ɪᴛ \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    IFLONG_FILE_NAME = " Only 64 characters can be named .  \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    ...
    NOYES_URL = "@robot URL detected. Please send me a fast URL so that I can upload to Telegram, without me slowing down for other users. \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    DOWNLOAD_FILE = "📥 Downloading  File "
    UPLOAD_FILE = " UploadinG 📤 \n\n To  transfer.sh \𝚗\𝚗 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    ANNO_UPLOAD = " UploadinG📤 \n\n To  anonfiles.com \𝚗\𝚗 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    BAY_UPLOAD = " UploadinG📤 \n\n To  bayfiles.com \𝚗\𝚗 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    GO_FILE_UPLOAD = " 📤UploadinG📤 \n\n To  gofile.io "
    DOWNLOAD_START = "ᴛʀʏɪɴɢ ᴛᴏ ᴅᴏᴡɴʟᴏᴀᴅ ⌛ 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots\n\n💮🌸 <i>{} 💮🌸</i>"
    UPLOAD_START = "📤 Uᴘʟᴏᴀᴅɪɴɢ Pʟᴇᴀsᴇ Wᴀɪᴛ 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
...
Upgrade your /plans to Remove Time Gaps and For link Processing 𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"""
    ...
    BANNED_USER_TEXT = "<code>You are Banned!</code> \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
    CHECK_LINK = "Pʀᴏᴄᴇssɪɴɢ ʏᴏᴜʀ ʟɪɴᴋ ⌛ \𝚗\𝚗𝚂𝚙𝚘𝚗𝚜𝚘𝚛𝚎𝚍 𝙱𝚢 : @AmRobots_Bots"
